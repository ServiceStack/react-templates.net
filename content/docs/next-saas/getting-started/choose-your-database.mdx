...
[Kamal destination](/docs/next-saas/operations/choose-a-database) the Release workflow deploys,
...
This Development-only task is idempotent. It uses `manager@email.com` for the populated customer
