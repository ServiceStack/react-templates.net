---
title: CLAUDE.md
description: Using CLAUDE.md and AGENTS.md files for AI-powered development with React .NET Templates
---
...
Each React .NET Template includes a comprehensive **CLAUDE.md** file designed to provide AI assistants like [Claude Code](https://claude.ai/code), Cursor, and other AI coding tools with the complete context needed to effectively work with your project.
