---
title: Next.js RSC - Secure by Design
summary: How this template's architecture protects against React Server Components vulnerabilities through process isolation and defense-in-depth security
tags: [security, nextjs, react, docker]
---

The [Next.js RSC](/docs/templates/next-rsc) template leverages Next.js React Server Components as a **pure rendering layer**, gaining the benefits of server-side rendering: improved performance, SEO, and reduced client bundle sizes - without the security risks inherent to fullstack Next.js applications.
...
This document details how the [Next.js RSC](/docs/templates/next-rsc) project template is architected to be **immune to React Server Components vulnerabilities** through:
